...
function create_object_types() {
    ...
    foreach ( $object_rows as $object_row ) {
        ...
        $save_fields_table = function () use ($fields_table_name, $object_id) {
            // check autosave
        ...
        $fields_box = new MetaBox ( type_name ( $object_row->name ), __('Fields'), $display_fields_table, $save_fields_table );

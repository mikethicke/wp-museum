...
const MoveToolbar = (props) => {
  ...
  return (
    <Toolbar>
      <ToolbarButton icon={chevronUp} onClick={moveUp} />
      <ToolbarButton icon={chevronDown} onClick={moveDown} />
    </Toolbar>
  );
};
...
const FieldEdit = (props) => {
  ...
  if (dimensionsData.n > 1) {
    for (let i = 0; i < dimensionsData.n; i++) {
      dimensionElements[i] = (
        <div className="dimension-field" key={i}>
          <label>
            Dimension {i + 1}
            <input
              type="text"
              ...
              onChange={(event) =>
                updateField(fieldId, `dimension.labels.${i}`, event)
              }
              onBlur={onFieldBlur}
            />
          </label>
  ...
  return (
    <div className="field-form">
      <MoveToolbar moveUp={moveUp} moveDown={moveDown} />
      ...
      <div className="field-type">
            ...
            <div className="field-section">
              <label>
                ...
                <input
                  ...
                  value={maxLength}
                  onChange={(event) =>
                    updateField(fieldId, "max_length", event)
                  }
                  onBlur={onFieldBlur}
                />
              </label>
              ...
              {factorModalOpen && (
                <FactorEditModal
                  ...
                  updateFactors={(newFactors) =>
                    updateFactors(fieldId, newFactors)
                  }
              ...
              <div className="field-section">
                <label>
                  ...
                  <select
                    ...
                    onBlur={(event) =>
                      updateField(fieldId, "dimension.n", event)
                    }
                  >
        ...
        {!newField && type === "measure" && dimensionsData.n > 1 && (
          <div className="field-type-group">
            <div className="dimension-labels">{dimensionElements}</div>
          </div>
        )}
      </div>
        ...
        <div className="field-section">
          <label>
            ...
            <textarea
              ...
              onChange={(event) =>
                updateField(fieldId, "detailed_instructions", event)
              }
              onBlur={onFieldBlur}
            />
          </label>
        ...
        <div className="field-section">
          <label>
            ...
            <textarea
              ...
              onChange={(event) =>
                updateField(fieldId, "public_description", event)
              }
              onBlur={onFieldBlur}
            />
          </label>

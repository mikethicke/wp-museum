...
if ( have_posts() ) {
    ...
    //retrieve inferno fields from database
    global $wpdb;
    $fields_table_name = $wpdb->prefix . "inferno_fields";
    ...
    <div id="content">
        ...
        <div class="inferno-post-categories"><?php the_category ( ' &middot; '); ?></div>
            ...
            if ( isset ( $custom[$field->slug][0] ) && ( $field->public == 1 || current_user_can ( 'read_private_posts' ) ) ) {
                ...
                <div class="field-text">
                    ...
                    if ( strlen ( $custom[$field->slug][0] ) > 39) {
                          ...
                          $field_text = '<div class="field-label-div">' . $field->name . ':</div>'. $custom[$field->slug][0].inferno_gallery ( array ( 'id' => $post->ID ) ); 

<?php
/**
 * Top page for collections, listing all collection description pages.
 */
...
if ( have_posts() ) {
    ...
    foreach ( $description_pages as $description_page ) {
        ...
        if ( $the_page->post_status == "publish" && $the_page->ID != $collections_page_id) post_row ( $post, $row_counter, $indent );
